    ...
    <section id="about" className="py-20 px-6 font-poppins">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="space-y-8 text-base md:text-lg text-gray-200 font-inter"
        >
          ...
          <div className="space-y-8">
            <p className="leading-relaxed text-center font-inter">
              I specialize in transforming complex technical challenges into elegant, user-centric solutions. My
              approach combines robust engineering practices with strategic business thinking, ensuring products are not
              just well-built but also deliver measurable value to users and businesses alike.
            </p>
          </div>
